...
public class InverseSymbolActivity extends RfidActivity {

	private static final String TAG = InverseSymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_inverse);
