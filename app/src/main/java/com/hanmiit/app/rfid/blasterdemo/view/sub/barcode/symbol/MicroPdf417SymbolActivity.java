...
public class MicroPdf417SymbolActivity extends RfidActivity {

	private static final String TAG = MicroPdf417SymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_micropdf417);
