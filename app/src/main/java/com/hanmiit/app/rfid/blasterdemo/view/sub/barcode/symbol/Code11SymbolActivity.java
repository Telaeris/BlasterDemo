...
public class Code11SymbolActivity extends RfidActivity {

	private static final String TAG = Code11SymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_code11);
