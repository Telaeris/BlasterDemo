...
public class I2of5SymbolActivity extends RfidActivity {

	private static final String TAG = I2of5SymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_i2of5);
