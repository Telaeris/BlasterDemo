...
public class CompositeSymbolActivity extends RfidActivity {

	private static final String TAG = CompositeSymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_composite);
