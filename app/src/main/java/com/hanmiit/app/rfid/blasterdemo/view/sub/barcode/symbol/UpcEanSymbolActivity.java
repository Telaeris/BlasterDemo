...
public class UpcEanSymbolActivity extends RfidActivity {

	private static final String TAG = UpcEanSymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_upc_ean);
