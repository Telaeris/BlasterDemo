...
public class AustraliaPostSymbolActivity extends RfidActivity {

	private static final String TAG = AustraliaPostSymbolActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_barcode_option_symbol_australia_post);
